...
c.app(f,{version:"1.0.15",instances:{},eventHandler:function(b,a){var d=f.instances[b];d&&d.__eventHandler(b,a)},augment:function(b,a){if(c.isString(a))a=[a];c.isArray(a)&&c.each(a,function(d){b.prototype[d]=function(){try{return this.callSWF(d,c.makeArray(arguments))}catch(e){this.fire("error",{message:e})}}})}});c.augment(f,c.EventTarget,{init:function(){if(this.__args){g.add.apply(g,this.__args);this.__args=null;delete this.__args}},__eventHandler:function(b,a){var d=a.type;a.id=b;switch(d){case "log":break;
default:this.fire(d,a)}},callSWF:function(b,a){a=a||[];try{if(this.swf[b])return this.swf[b].apply(this.swf,a)}catch(d){var e="";if(a.length!==0)e="'"+a.join("','")+"'";return(new Function("self","return self.swf."+b+"("+e+");"))(this)}}});f.augment(f,["activate","getReady","getCoreVersion"]);window.AJBridge=c.AJBridge=f},{requires:["flash"]});
